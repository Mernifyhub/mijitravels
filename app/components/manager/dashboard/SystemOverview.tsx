// app/components/manager/dashboard/SystemOverview.tsx
"use client";

import {
  ArrowUpRight, Clock, UserPlus, UserCheck, Ticket,
  CircleDollarSign,
} from "lucide-react";
...
export default function SystemOverview({ stats }: SystemOverviewProps) {
  ...
  const overviewItems = [
    ...
    },
    {
      ...
      icon: <UserPlus size={14} className="text-yellow-600" />,
      bg: "bg-yellow-50",
    ...
    },
    {
      ...
      value: stats.todayConfirm || 0,
      icon: <Ticket size={14} className="text-blue-600" />,
      bg: "bg-blue-50",
      color: "text-blue-600",
    },
    {
    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm h-fit">
      ...
      <div className="space-y-3">
        {overviewItems.map((item, index) => (
          <div
            key={index}
            className={`flex items-center justify-between py-2 px-3 ${item.bg} rounded-lg`}
          >
