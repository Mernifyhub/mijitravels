    ...
    <div className="min-h-[70vh] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="relative mx-auto w-24 h-24 mb-6">
          ...
          <div className="relative w-24 h-24 bg-gradient-to-br from-red-50
            to-red-100 rounded-full flex items-center justify-center
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6 border border-gray-200">
            <div className="flex items-center justify-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white
                ...
                <span className="text-xs font-bold text-gray-800 bg-blue-100
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          {showHomeButton && (
            <button
              ...
              className="flex items-center justify-center gap-2 px-5 py-2.5
                bg-[#021f3b] text-white rounded-xl hover:bg-[#0a3a6b]
