...
export default function TravelerDropdown({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div
          className="absolute left-0 top-0 bottom-0 w-14 bg-gradient-to-br
      ...
      {showDropdown && (
        ...
        >
          {/* Header */}
          <div
            className="px-5 py-4 bg-gradient-to-r from-[#021f3b] to-[#0a4d8c]
            text-white"
          >
          ...
          {infants > 0 && (
            <div className="mx-5 mb-4 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 flex items-start gap-3">
              ...
              <p className="text-xs text-amber-700 leading-relaxed">
                Infants must sit on an adult&apos;s lap. Max {adults} infant
                {adults > 1 ? "s" : ""} allowed.
              </p>
            </div>
          )}
