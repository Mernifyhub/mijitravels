...
import {
  Clock, CheckCircle2, XCircle, AlertCircle, Ban, RotateCcw,
} from "lucide-react";
...
export const getPageTitle = (defaultStatus: string): string => {
  const titles: Record<string, string> = {
    ON_HOLD: "On Hold Bookings",
    CONFIRMED: "Confirmed Bookings",
    CANCELLED: "Cancelled Bookings",
    VOIDED: "Voided Bookings",
    REFUNDED: "Refunded Bookings",
  };
  return titles[defaultStatus] || "All Bookings";
};
...
// ✅ Final column order with departure after route
