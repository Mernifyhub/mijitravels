...
import { X, Receipt, Printer, Copy } from "lucide-react";
        ...
        >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className={`inline-flex items-center gap-1 px-2 py-0.5
                  rounded-full text-xs font-semibold ${tc.bg} ${tc.text}`}>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className={`rounded-xl p-4
              ${entry.credit > 0 ? "bg-emerald-50" : "bg-rose-50"}`}>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {Boolean(meta.airline) && (
                <div className="bg-slate-50 rounded-xl p-3">
                  <p className="text-xs text-slate-500 mb-1">Airline</p>
                  <p className="font-medium text-slate-800 text-sm">
                    {String(meta.airline)}
                  </p>
                </div>
          ...
          <div className="px-6 py-4 border-t border-slate-100 flex items-center
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => navigator.clipboard.writeText(entry.reference)}
                className="p-2 hover:bg-white rounded-lg transition"
