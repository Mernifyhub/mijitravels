...
//   return (
//     <section className="relative w-full h-[450px] flex items-center bg-[#061229] overflow-hidden -mt-6">
//       {/* Background Image */}
...
//               >
//                 {/* Badge */}
//                 <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 px-3 py-1 rounded-full mb-4 backdrop-blur-sm">
...
const BASE_OFFERS: BaseOffer[] = [
  ...
  },
  {
    ...
    descBDT: 38500,
    descText: "Special honeymoon packages and direct flight fares starting from only",
    image: "https://images.unsplash.com/photo-1517479149777-5f3b1511d5ad?q=80&w=2070&auto=format&fit=crop",
    link: "#maldives",
  },
  {
    badge: "Spiritual Journey",
  ...
  {
    badge: "Sky High Adventures",
    title: "Fly Above the",
    highlight: "Clouds in Style",
    desc: "Get up to 15% discount on premium airlines with business class comfort this season.",
