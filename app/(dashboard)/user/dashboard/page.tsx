...
// ─── Transaction Icon ─────────────────────────────────────────────────────────
function getTransactionIcon(type: string): React.ReactElement {
  const icons: Record<string, React.ReactElement> = {
...
export default function AgentDashboardPage() {
    ...
    const fetchAllData = async () => {
      try {
        ...
        if (dashboardResult.status === "fulfilled") {
          ...
          if (String(dashboardResult.reason).includes("401")) unauthorized = true;
        }
        ...
        if (balanceResult.status === "fulfilled") {
          ...
          if (String(balanceResult.reason).includes("401")) unauthorized = true;
        }
  ...
  // ✅ Fixed — cast to Transaction["status"] which now includes "success"
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-r from-[#021f3b] to-[#0a4d8c]
                ...
                <div className="flex flex-col md:flex-row md:items-start
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-3 bg-white
                      text-[#021f3b] rounded-xl font-semibold hover:bg-blue-50
                      transition shadow-lg self-start"
                  >
                    <Search size={20} />
                    Search Flights
                  </button>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="text-xs font-semibold text-[#021f3b] bg-blue-50 px-2.5 py-1
                  rounded-lg hover:bg-blue-100 transition-colors flex items-center gap-1"
              >
                History <ArrowRight size={12} />
              </button>
            </div>

            <div className="relative overflow-hidden rounded-xl p-4 mb-4 text-white
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        ...
                        remainingPercent < 50 ? "#F59E0B" : "#10B981",
            ...
            <button
              ...
              className="w-full mt-4 py-2.5 bg-[#021f3b] text-white rounded-xl
                font-semibold hover:bg-[#0a3a6b] active:scale-[0.98] transition-all
                    ...
                    recentBookings.map((booking) => (
                      <tr key={booking.id} className="hover:bg-gray-50 transition">
                        <td className="px-6 py-4">
                          <span className="font-mono font-semibold text-[#021f3b]">
                            {booking.pnr}
                          </span>
                        </td>
                        <td className="px-6 py-4">
          ...
          {quickActions.map((action, index) => (
            <button
              ...
              className="bg-white rounded-xl p-5 shadow-sm hover:shadow-md
                transition-all hover:-translate-y-1 group text-left"
            >
              <div className={`w-12 h-12 ${action.color} rounded-xl flex items-center
                justify-center text-white mb-3 group-hover:scale-110 transition`}>
                {action.icon}
              </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between
          gap-4 bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-gray-100
              rounded-lg text-gray-600 hover:bg-gray-200 transition text-sm">
              <Download size={16} />
              Export
            </button>
            <button
              onClick={() => window.location.reload()}
              className="flex items-center gap-2 px-4 py-2 bg-[#021f3b] text-white
                rounded-lg hover:bg-[#0a3a6b] transition text-sm"
            >
              <RefreshCw size={16} />
              Refresh
            </button>
        ...
        {/* ── Notice Banner ── */}
        <div className="bg-gradient-to-r from-[#021f3b] via-[#0a3a6b]
          to-[#0a4d8c] rounded-2xl p-6 text-white">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200">
                  You have {stats?.totalBookings || 0} total bookings.
                  Keep booking to unlock higher tiers!
                </p>
              </div>
            </div>
            <button className="px-6 py-3 bg-white text-[#021f3b] rounded-xl
