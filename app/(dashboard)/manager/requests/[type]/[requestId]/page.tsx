...
export default function AdminRequestProcessPage() {
  ...
  // ✅ string | null — কোন button processing-এ আছে track করে
  ...
  const handleProcess = async (action: "APPROVED" | "REJECTED" | "PROCESSING") => {
    ...
    setProcessing(action); // ✅ শুধু clicked button-এর action set
                      ...
                      <div className={`px-4 py-2.5 flex items-center justify-between ${
                        ...
                        <div className="flex items-center gap-3">
                          <div className={`w-9 h-9 rounded-xl flex items-center justify-center font-black text-sm shadow-sm ${
                            ...
                            {pax.type === "INFANT" ? <Baby size={16} /> : pax.firstName?.[0]?.toUpperCase() || <User size={16} />}
                          </div>
                          <div>
                            <div className="flex items-center gap-2">
              ...
              {done ? (
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    {/* ✅ Approve — শুধু এই button-এ spinner */}
                    <button
                    ...
                    {/* ✅ Mark Processing — শুধু এই button-এ spinner */}
                    <button
                    ...
                    {/* ✅ Reject — শুধু এই button-এ spinner */}
                    <button
