...
export default function AdminRequestProcessPage() {
    ...
    try {
      ...
      setRequest((prev: any) => ({
        ...
        assignedTo:   data.assignedTo || {
          agentName: currentUserName, firstName: currentUserName, lastName: "",
        },
  ...
  const handleProcess = async (action: "APPROVED" | "REJECTED" | "PROCESSING") => {
    ...
    try {
      ...
      setTimeout(() => router.push(`/manager/requests/${type}`), 2000);
    } catch (e: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* ── Locked Warning ── */}
        {isAssignedToOther && (
          <div className="mb-4 flex items-center gap-3 bg-orange-50
            border-2 border-orange-200 rounded-xl px-4 py-3">
        ...
        {/* ── Success Banner ── */}
        {done && (
          <div className="mb-4 flex items-center gap-3 bg-emerald-50
        ...
        <div className="grid lg:grid-cols-3 gap-6">
            ...
            {isIssue && (
              ...
              >
                <div className="bg-gradient-to-r from-emerald-600 to-emerald-700
                  ...
                  <span className="ml-auto text-[9px] font-black text-emerald-200
                ...
                <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* GDS PNR */}
                  <div>
                    <label className="block text-[9px] font-black text-gray-400
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        autoComplete="off"
                        className="w-full pl-9 pr-3 py-2.5 border-2 border-gray-100
                          focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100
                          rounded-xl text-sm font-mono font-black outline-none transition
                          disabled:bg-gray-50 disabled:opacity-60 uppercase"
                      />
                    </div>
                  </div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2.5 border-2 border-gray-100
                          ...
                          placeholder:text-gray-300 disabled:bg-gray-50 disabled:opacity-60"
                      />
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-slate-700 to-slate-800
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-black bg-white/20 text-white
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`w-9 h-9 rounded-xl flex items-center justify-center
                            font-black text-sm shadow-sm
                            ${pax.type === "ADULT" ? "bg-indigo-600 text-white" :
                              pax.type === "CHILD" ? "bg-amber-500  text-white" :
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[8px] font-black text-gray-400
                                bg-white border border-gray-200 px-1.5 py-0.5 rounded-md">
                                PAX {i + 1}
                              </span>
                            </div>
                            <div className="flex items-center gap-2 mt-0.5">
                              <span className={`text-[8px] font-black uppercase
                                tracking-widest px-1.5 py-0.5 rounded-md
                          ...
                          {pax.passportNumber && (
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-[10px] font-black text-gray-800 font-mono">
                                  {pax.passportNumber}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  {new Date(pax.passportExpiry) < new Date() && (
                                    <span className="ml-1 text-[8px] bg-red-100 text-red-600
                                      px-1 rounded">
                                      EXPIRED
                                    </span>
                                  )}
          ...
          <div className="space-y-4">
            ...
            {/* ── Fare Breakdown ── */}
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              <h3 className="text-[10px] font-black text-gray-400 uppercase
                tracking-widest mb-4 flex items-center gap-1.5">
                ...
                return (
                  <div className="space-y-1.5">
                    ...
                    {f.adults > 0 && (
                      <div className="flex justify-between items-center py-1">
                        ...
                        <span className="text-xs font-black text-slate-700">
                          {cur} {f.totalBaseTax.toLocaleString()}
                        </span>
                      </div>
                    )}
                    {f.children > 0 && (
                    ...
                    <div className="flex justify-between items-center py-1">
                      ...
                      <span className="text-xs font-black text-slate-700">
                        {cur} {f.baseFare.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-1">
                      <span className="text-xs text-slate-500">Tax & Fee</span>
                      <span className="text-xs font-black text-slate-700">
                        {cur} {f.taxAmount.toLocaleString()}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center py-1.5
                      ...
                      <span className="text-xs font-black text-blue-800">
                        {cur} {f.customerInvoiceTotal.toLocaleString()}
                      </span>
                    </div>
                    {f.discountOrCommission > 0 && (
                      <div className="flex justify-between items-center py-1.5
                        ...
                        <span className="text-xs font-black text-emerald-700">
                          − {cur} {f.discountOrCommission.toLocaleString()}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between items-center py-3 px-3 mt-1
                      ...
                      <span className="text-xl font-black text-white">
                        {cur} {f.grandTotal.toLocaleString()}
                      </span>
                    </div>
                    ...
                    {f.totalPax > 1 && (
                      <div className="flex justify-between items-center py-1 px-1">
                        ...
                        <span className="text-xs font-black text-slate-500">
                          {cur} {f.perPerson.toLocaleString()}
                        </span>
                      </div>
                    )}
                        ...
                        <div>
                          ...
                          <div className="bg-emerald-50 rounded-xl border border-emerald-100 overflow-hidden">
                            ...
                            {a.agentDiscount === 0 && a.promoDiscount === 0 && a.commission === 0 && (
                              <div className="px-3 py-2 text-xs text-emerald-600 italic">
                        ...
                        <div>
                          ...
                          <div className="bg-sky-50 rounded-xl border border-sky-100 overflow-hidden">
                            ...
                            {a.ait === 0 && a.vat === 0 && a.roundOff === 0 && (
                              <div className="px-3 py-2 text-xs text-sky-600 italic">
                                No tax applied
                              </div>
                            )}
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <div className="bg-indigo-50 rounded-xl p-2.5
                              ...
                              <p className="text-xs font-black text-indigo-800">
                                {cur} {a.grossProfit.toLocaleString()}
                              </p>
                            </div>
                            <div className="bg-emerald-50 rounded-xl p-2.5
                              ...
                              <p className="text-xs font-black text-emerald-800">
                                {cur} {a.netProfit.toLocaleString()}
                              </p>
                            </div>
                            <div className="bg-purple-50 rounded-xl p-2.5
                              border border-purple-100 text-center">
                              <p className="text-[8px] font-black text-purple-500
                                uppercase tracking-widest mb-1">
                                Margin
                              </p>
                            ...
                            {[
                              ...
                              <div key={i} className="flex justify-between items-center py-0.5">
                                ...
                                <span className="text-[10px] font-black text-slate-600
                                  capitalize bg-white px-2 py-0.5 rounded-lg
            ...
            >
              ...
              {done ? (
                <div className={`w-full py-4 rounded-xl flex items-center justify-center
                  gap-2 font-black text-sm border-2
                ...
                <>
                  <textarea
                    ...
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5
                      text-sm outline-none focus:border-[#021f3b] resize-none
                      placeholder:text-gray-300 mb-3 transition
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className={`w-full py-3 rounded-xl text-white font-black text-sm
                        uppercase tracking-widest transition active:scale-95
                    ...
                    {!isAssigned ? (
                      <button
                        ...
                        className="w-full py-2.5 rounded-xl bg-[#021f3b] hover:bg-[#0a3a6b]
                      ...
                      <div className="w-full py-2.5 rounded-xl bg-orange-50
                        border border-orange-200 text-orange-700 font-black text-xs
                  ...
                  {isAssignedToOther && (
                    <p className="text-[9px] text-orange-600 text-center mt-2
