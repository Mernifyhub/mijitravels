...
import {
  Plane, DollarSign, Clock, ArrowUpRight, RefreshCw,
  Bell, CheckCircle, XCircle, AlertCircle, Eye, ArrowRight,
  Ticket, UserPlus, BarChart3, Settings, Percent, Shield,
  CircleDollarSign, UserCheck, Trophy, Loader2, Wallet, Ban
} from "lucide-react";
...
export default function ManagerDashboardPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // ✅ Manager API - Same structure, same data
  ...
  // ✅ requestStats সরাসরি data থেকে আসছে - আলাদা fetch দরকার নেই
  ...
  const quickActions = [
    { icon: <Bell size={24} />, label: "CMS / Notice", color: "bg-blue-500", route: "/manager/notice" },
    { icon: <Percent size={24} />, label: "Markup Settings", color: "bg-purple-500", route: "/manager/markup" },
    { icon: <CircleDollarSign size={24} />, label: "Agent Deposits", color: "bg-green-500", route: "/manager/agent/agent-deposit-list" },
    { icon: <BarChart3 size={24} />, label: "Sales Report", color: "bg-orange-500", route: "/manager/sales/sales-report" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* WELCOME SECTION & SYSTEM OVERVIEW */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#021f3b] to-[#0a4d8c] rounded-2xl p-6 text-white">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <h1 className="text-2xl md:text-3xl font-bold mt-1">{managerName}! 👋</h1>
            ...
            {/* ✅ Booking Requests - requestStats সরাসরি data থেকে */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Issue, reissue, cancel, void & refund requests
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                {requestCards.map((item, index) => (
                  ...
                  >
                    {/* ✅ Count Badge */}
                    {item.count > 0 && (
                      <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-red-500 text-white text-xs font-bold flex items-center justify-center shadow-md z-10">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm h-fit">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2 px-3 bg-orange-50 rounded-lg">
                ...
                <span className="font-bold text-orange-600">{stats.pendingDeposits || 0}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 bg-yellow-50 rounded-lg">
                ...
                <span className="font-bold text-yellow-600">{stats.pendingAgents || 0}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 bg-green-50 rounded-lg">
                ...
                <span className="font-bold text-green-600">{stats.totalAgents || 0}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 bg-blue-50 rounded-lg">
                ...
                <span className="font-bold text-blue-600">{stats.todayConfirm || 0}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 bg-blue-50 rounded-lg">
                <span className="text-gray-600 text-sm flex items-center gap-2">
                  <Ticket size={14} className="text-blue-600" />
                ...
                <span className="font-bold text-blue-600">{stats.todayBookings || 0}</span>
              </div>
              <div className="flex items-center justify-between py-2 px-3 bg-blue-50 rounded-lg">
                <span className="text-gray-600 text-sm flex items-center gap-2">
                  <Ticket size={14} className="text-blue-600" />
                ...
                <span className="font-bold text-blue-600">{stats.todayDeposits || 0}</span>
              </div>
            </div>

            <button
              onClick={() => router.push("/manager/agent/agent-deposit-list")}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              ...
              <button
                onClick={() => router.push("/manager/bookings/all-bookings")}
                className="text-sm text-[#021f3b] font-medium hover:underline flex items-center gap-1"
              >
                View All <ArrowRight size={14} />
              </button>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-2">{stats.pendingDeposits || 0}</h3>
              </div>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-2">{stats.pendingAgents || 0}</h3>
              </div>
              <UserPlus size={28} />
            </div>
          </div>
